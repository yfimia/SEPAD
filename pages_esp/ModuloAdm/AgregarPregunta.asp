  ...
  <tr> 
    <td class="ToolBar"><table border="0" cellspacing="0" cellpadding="0" class="ToolBar">
        <tr> 
          ...
          <td class="HeaderTable">Adicionar Pregunta</td>
        </tr>
      </table>
    </td>
  </tr>
  <tr>
   <form id="formDatosAgregar" name="formDatosAgregar" action="procesoAgregarPregunta.asp" method="post">
     <table border=0 cellpadding=0 cellspacing=0 width="100%">
       <tr class="MessageTR">
        <td align="center" width="1%">Pregunta:</td><td><input type=text id="question" name="question" size=60></td>
       </tr>
       <tr class="MessageTR1">
        <td align="center" width="1%" valign="top">Respuesta:</td><td><textarea id="response" name="response" cols=60 rows=28></textarea></td>
       </tr>
       <tr>
