  ...
  <tr> 
    <td class="ToolBar"><table border="0" cellspacing="0" cellpadding="0" class="ToolBar">
        <tr> 
          ...
          <td class="HeaderTable">Modificar/Eliminar Palabra</td>
        </tr>
      </table>
    </td>
  </tr>
  <tr>
   <form id="formDatosEliminar" name="formDatosEliminar" action="procesoEliminarPalabra.asp" method="post">
     <table border=0 cellpadding=0 cellspacing=0 width="100%">
       <tr class="ToolBar">
        <td width="1%">&nbsp;</td><td>Palabra</td><td>&nbsp;</td><td>Significado</td><td>&nbsp;</td><td>Modificar&nbsp;(M)</td>
       </tr>
           <%
              var oRec, oConn;
              ...
              var Sql = "SELECT * FROM Glosarios where IdCurso = " + Session("admcurso") + " ORDER BY Palabra";
           ...
           %>
             <tr class="<%=clase%>">
              ...
              <td><font color=white>|</font></td>
              <td align="center">
               <a href="FormModificarPalabra.asp?idp=<%=oRec.Fields.Item("Id")%>">M</a>
              </td>
             </tr>
           <%
               oRec.move(1);
