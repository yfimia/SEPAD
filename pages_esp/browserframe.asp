...
function modList() 
 {
   parent.parent.frames("mainFrame").location.href = 'modulo.asp?uid=<%=uid%>&ID=<%=Session("modulo")%>&Name=<%=Session("moduloName")%>&state=<%=Session("state")%>&cordinador=<%=Session("cordinador")%>&grupo=<%=Session("grupo")%>&claustro=<%=Session("claustro")%>';
   parent.parent.frames("leftFrame").location.href = "selection.asp?uid=<%=uid%>&flag=1";
 }
  ...
  <tr> 
    <td align=right> 
      <table border="0"  cellspacing="0" cellpadding="2" width="171">
        <tr> 
          <td ><a  href="javascript:modList()"  ><img title="Generalidades de la Modalidad" src="../images/<%=Session("skin")%>/modalidad.gif"  width="20" height="20" border="0" ></a></td>
          ...
          <td class="Separator">|</td>
          <td  ><a href="glosario\glosario.asp?uid=<%=uid%>&Letra=Todas&IDP=0&IdCurso=<%=Session("course")%>&courseName=<%=Session("courseName")%>"  target="mainFrame1"  ><img title="Glosario" src="../images/<%=Session("skin")%>/glosario.gif"  width="20" height="20" border="0" ></a></td>
          <td class="Separator">|</td>
          <td  ><a href="faq.asp?uid=<%=uid%>&IdCurso=<%=Session("course")%>&courseName=<%=Session("courseName")%>"  target="mainFrame1"  ><img title="FAQ" src="../images/<%=Session("skin")%>/faq.gif"  width="20" height="20" border="0" ></a></td>
...
%>          
          ...
          <td class="Separator">|</td>
          <td  ><a href="Upload/downloads.asp"  target="mainFrame1"  ><img title="Descargas" src="../images/icons/pack_rar.gif"  width="17" height="17" border="0" ></a></td>
          <td >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
