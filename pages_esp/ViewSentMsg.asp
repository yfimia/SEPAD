...
//      MarkReaded( Request.QueryString.Item("ID") );
      ...
      oConn.Open(filePath);
      oRec.Open("SELECT * from Mensajes_Enviados Where (ID = " + Request.QueryString.Item("ID") + ")",oConn,3,3);    
%>
  ...
  <tr> 
    <td>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td class="MessageTR1"> 
            <textarea name="content" id=Texto rows="28" class="TextArea"><%=oRec.Fields("Content").Value %></textarea>
          </td>
        </tr>
        <tr> 
