...
<form name=Delnews action="ConfirmDeleteMatricula.asp?uid=<%=uid%>" method="post">
<%    
    ...
    <td>
      <table border="0" cellspacing="0" cellpadding="4" class="ToolBar">
        <tr> 
          ...
          <td>|</td>
          <td><a href="deleteMatriculas.asp?uid=<%=uid%>&first=<%=last%>" class="ToolLink">&nbsp;Próximos&nbsp;<%=SHOW_CANT%>&nbsp;</a></td>
        </tr>
      </table>
    </td>
  </tr>
