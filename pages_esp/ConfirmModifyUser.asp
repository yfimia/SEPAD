             ...
             if ((Request.Form("passw").Count > 0) && (Request.Form("passw") != ""))
               {
                 ...
                 if (Session("name") == Request.Form("defaultnick") ) 
