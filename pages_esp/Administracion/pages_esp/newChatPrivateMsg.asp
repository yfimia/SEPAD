...
%>  
    ...
    <tr>
      ...
      <td width="1%">
        ...
        %>
        <b><a href="javascript:abreVentana( 'SalaPrivadaDe<%=Session("userID")%>Para<%=oRec.Fields.Item("name").value%>', 800, 400, 'newChatPrivateMessanger.asp?salaid=<%=sala%>&userid=<%=oRec.Fields.Item("UserOrigen").value%>');"><%=oRec.Fields.Item("name").value%></a></b>      
        <%}
        %>
      </td>
      <td width="0%">
