...
<table width="100%" border="0" cellspacing="2" cellpadding="0">
  <tr> 
    ...
    <td valign="top"> 
      <table width="100%" border="0" cellspacing="2" cellpadding="0">
        <tr> 
          <td width="1%"><b>Título: </b></td>
          <td width="84%"><A href="../downloads/SepadXM1.0.zip">SEPADXMail 1.0</A>&nbsp;<STRONG>(758 kb)</STRONG></td>
        </tr>  
        <tr> 
          <td colspan="2"> Cliente para acceso a SEPAD a través de protocolos de correo elétronico.</td>
        </tr>
      </table>
    </td>
  </tr>
  ...
  <tr> 
    ...
    <td valign="top"> 
      <table width="100%" border="0" cellspacing="2" cellpadding="0">
        ...
        <tr> 
          <td colspan="2"> Herramienta para la publicación en SEPAD 1.5.</td>
        </tr>
      </table>
    </td>
  </tr>
