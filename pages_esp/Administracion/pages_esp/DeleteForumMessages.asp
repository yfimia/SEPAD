...
<%
  ...
  if (Session("PermissionType") == ADMINISTRATOR)
    ...
    if (Request.QueryString.Item("first").Count != 0) {
      ...
      if (first != -1) {
        where = " and (ForumMessages.ID > " +  first + ")";
      } 
    } 
...
<form name=Delnews action="ConfirmDeleteForumMessages.asp?uid=<%=uid%>" method="post">
<%    
      ...
      oComm.CommandText = "SELECT Top " + SHOW_CANT + " ForumMessages.ID,ForumMessages.Texto,ForumMessages.Fecha,Usuarios.FullName FROM ForumMessages,Usuarios WHERE (ForumMessages.[User] = Usuarios.ID) " + where;
      oRec = oComm.Execute();    
%>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td class="ToolBar" align="center"><h1><b>Listado de Mensajes</b></h1></td>
  </tr>
  <tr> 
    <td> 
      <table width="100%" border="0" cellspacing="1" cellpadding="0">
        <tr> 
          ...
          <td width="55%" class="ToolBar" align="center"><b>Texto</b></td>
          <td width="35%" class="ToolBar" align="center"><b>Fecha</b></td>
        </tr>
...
%>
        <tr> 
          ...
          <td width="35%" class="<%=clase%>"><%=oRec.Fields.Item("Texto").value%></td>
    ...
    <td>
      <table border="0" cellspacing="0" cellpadding="4" class="ToolBar">
        <tr> 
          ...
          <td>|</td>
          <td><a href="DeleteForumMessages.asp?uid=<%=uid%>&first=<%=last%>" class="ToolLink">&nbsp;Próximos&nbsp;<%=SHOW_CANT%>&nbsp;</a></td>
        </tr>
      </table>
    </td>
  </tr>
