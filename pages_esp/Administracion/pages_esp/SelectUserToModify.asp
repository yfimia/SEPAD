    ...
    <td> 
      <table width="100%" border="0" cellspacing="1" cellpadding="0">
        <tr> 
          ...
          <td width="40%" class="ToolBar" align="center"><b>Correo electrónico</b></td>
        </tr>
<%    
  ...
  <tr>
    <td>
      <table border="0" cellspacing="0" cellpadding="4" class="ToolBar">
        <tr> 
          <td><a href="SelectUserToModify.asp?uid=<%=uid%>&first=<%=last%>" class="ToolLink">&nbsp;Próximos&nbsp;<%=SHOW_CANT%>&nbsp;</a></td>
        </tr>
      </table>
    </td>
  </tr>
