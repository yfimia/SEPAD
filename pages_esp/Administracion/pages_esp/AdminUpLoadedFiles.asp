...
<html>
<head>
<title>Manipular trabajos enviados</title>
...
<form name=Delnews action="ConfirmDeleteTrab.asp?uid=<%=uid%>" method="post">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
     <td class="ToolBar" align="center"><b>Listado de trabajos enviados para el curso >>
      <%=Session("CourseName")%></b></td>  </tr>
  <tr> 
    <td> 
...
<%
      ...
      var SQL        = "SELECT  Top " + SHOW_CANT + "  Seminarios.ID, Seminarios.fileTitle, Seminarios.fileSize, Seminarios.fileDescription, Seminarios.fileURL, Seminarios.uploadDate, Usuarios.FullName " + 
...
%>
        <tr class="<%=trclass %>"  valign="middle"> 
          ...
          <td width="20%" align=center><%=oRec.Fields.Item("FullName") %></td>
...
%>
        <tr class="<%=trclass %>"  valign="middle"> 
          <td width="28%" align="left" colspan=3 ><b> Tamaño usado: </b><%=size%>&nbsp;kb </td>
	      <td width="72%" align="left" colspan=3><b> Tamaño máximo permitido:&nbsp;</b><%= Session("maxMem") %> kb</td>
        </tr>
<%
     if (Count > 0) 
        {
    ...
    <td class="ToolBar">
      <table border="0" cellspacing="0" cellpadding="4" class="ToolBar">
        <tr> 
          ...
          <td>|</td>
          <td><a href="#" class="ToolLink" onClick="close_window()">&nbsp;Cerrar&nbsp;</a></td>
          <td>|</td>
          <td><a href="adminuploadedfiles.asp?uid=<%=uid%>&first=<%=last%>" class="ToolLink">&nbsp;Próximos&nbsp;<%=SHOW_CANT%>&nbsp;</a></td>
        </tr>
      </table>
    </td>
  </tr>
