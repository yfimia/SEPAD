...
<table width="100%" border="0" cellspacing="1" cellpadding="1" class="StatisticTable">
  <tr>
    <td width="55%" align=center><%= TEXT11 %></td>
    <td width="40"  align=center><%= TEXT12 %></td>
...
%>
  <tr> 
    <td width="55%" class="<%=clase%>"><%=oRec.Fields.Item("LName")%></td>
    <td width="40%" class="<%=clase%>"><%=fch%></td>
...
%>
  <tr> 
    <td colspan=2 class="<%=clase%>"><b><%= TEXT14 %></b></td>
