...
<html>
<head>
<title> Modalidad Academica : <%=Session("moduloName")%> </title>
...
<%    
      ...
      sql = "SELECT  Usuarios.ID, Usuarios.email, Usuarios.Name, Usuarios.FullName FROM Usuarios INNER JOIN Grupos_de_Usuarios ON Usuarios.ID = Grupos_de_Usuarios.[User] WHERE (((Grupos_de_Usuarios.[Group])=" + Session("Grupo") + "))";
  ...
  <tr> 
    <td class="ToolBar">
      <table border="0" cellspacing="0" cellpadding="0" class="ToolBar">
        ...
        <tr> 
          <td><h5 style="color: #ffffff">Grupo:&nbsp;<%=Session("moduloName")%></h5></td>
        </tr>
      </table>
    </td>
  </tr>
