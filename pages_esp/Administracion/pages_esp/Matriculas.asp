...
<html>
<head>
<title>Solicitud de matrícula satisfactoria</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
<link rel="stylesheet" href="../css/<%=Session("skin")%>/Main.css" type="text/css">
</head>
...
//-->
                      ...
                      <center><b>Su solicitud ha sido archivada satisfactoriamente. Se le notificará su matrícula a través de la cuenta de correo electrónico que acaba de especificar
                       , si no especificó ninguna usted será el encargado de revisar intentando conectarse al sistema con la contraseña especificada.</b></center>
                      <center><input type=Button Value=Cerrar onclick='closewin()' id=Button1 name=Button1></center>
</body>                      
</html>
<%                      
                    }  
