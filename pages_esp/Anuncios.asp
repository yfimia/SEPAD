...
<%
if ((Session("PermissionType") == ADMINISTRATOR) || (Session("userID") == Session("cordinador")) || (Session("userID") == Session("courseOwner"))) {
%>
          <td width=1% valign=bottom align=right><a href="javascript:abreVentana('CrearAnuncios', 850, 480, 'CrearAnuncio.asp?uid=<%=uid%>&idmodulo=<%=Session("modulo")%>')" class="ToolLink">Crear&nbsp;Anuncio</td>
<%
  }
%>          
        </tr>
...
<%
 if ((Session("PermissionType") == ADMINISTRATOR) || (Session("userID") == Session("cordinador")) || (Session("userID") == oRec.Fields.Item("Publisher"))) {
 %>
   <a href="javascript:abreVentana('MAnuncios', 850, 480, 'MAnuncios.asp?uid=<%=uid%>&idmodulo=<%=idmod%>&idanuncio=<%=IDAnuncio%>')">Modificar</a>
 <%
 }
 if ((Session("PermissionType") == ADMINISTRATOR) || (Session("userID") == Session("cordinador")) || (Session("userID") == oRec.Fields.Item("Publisher"))) {
 %>
