    ...
    <td class="ToolBar">
      <table border="0" cellspacing="0" cellpadding="0" class="ToolBar">
        <tr> 
          ...
          <td class="HeaderTable">Resultados de la evaluaci&oacute;n</td>
        </tr>
      </table>
    </td>
  </tr>
  <tr> 
    <td> 
      <table width="100%" border="0" cellspacing="1" cellpadding="0">
        <tr> 
                <td class="MessageTR1" width="20%" align="center"><b>Número</b></td>
                <td class="MessageTR1" width="40%" align="center"><b>Correctas</b></td>
                <td class="MessageTR1" width="40%" align="center"><b>Calificación</b></td>
        </tr>
...
%>
        <tr> 
                ...
                <td class="<%=clase%>" width="40%" align="center"><%=bien%>  de <%=Session("exer").items.cant[Session("Cuales").items[j]]%></td>
...
%>
        <tr> 
                <td class="<%=clase%>" width="20%" align="center"><%=(j + 1)%></td>
                <td class="<%=clase%>" width="40%" align="center">Pendiente</td>
                <td class="<%=clase%>" width="40%" align="center">Pendiente</td>
        </tr>
<%     
        ...
        <tr> 
          <td colspan="3" class="ToolBar"> 
            <table border="0" cellspacing="0" align="center" cellpadding="5">
              <tr> 
                <td  class="ToolBar"><a href="docs.asp?uid=<%=uid%>&lesson=<%=Session("lastLesson")%>&lessonurl=<%=Session("lastLessonUrl")%>&lessonindex=<%=Session("lastLessonIndex")%>&lessonname=<%=Session("lastLessonName")%>" class="ToolLink">&nbsp;Aceptar&nbsp;</a></td>
              </tr>
            </table>
          </td>
        </tr>
