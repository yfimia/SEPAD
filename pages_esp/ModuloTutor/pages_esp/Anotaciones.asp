...
function elimina(leccion, material, user)
{
  window.history.back;
}
...
<form name=anotac id=anotac action="docs.asp?uid=<%=uid%>&lesson=<%=lesson%>&material=<%=material%>" method=post  LANGUAGE=javascript >
  ...
  <table border="0" cellspacing="1" cellpadding="1" align="center" width="100%">
    <tr width="100%">
      <td align="right" cellspacing="0" cellspadding="0" width="50%" class="ToolBar">Lecci&oacuten:</td>
      <td cellspacing="0" cellspadding="0" width="50%" class="ToolBar"><%=leccion%></td>
    </tr>
    <tr width="100%">
      <td align="right" cellspacing="0" cellspadding="0" width="50%" class="ToolBar">Material:</td>
      <td cellspacing="0" cellspadding="0" width="50%" class="ToolBar"><%=mater%></td>
    </tr>
    <tr width="100%">
      <td colspan="2" class=MessageTR>
        <textarea align="center" id="texto" name="texto" width="100%" height="100%">
        <%if (!oRec.EOF) 
          {
            %><%=oRec.Fields("Texto").Value%><%;
          }
        %>
        </textarea>
      </td>
      ...
      <table border="0" cellspacing="1" cellpadding="1" align="center" width="100%">
        <tr width="100%">
          ...
          <td  Class="Toolbar" align="center" width="100%">
            <input type=button value="Eliminar" id=button1 name=button1 onclick="elimina(<%=lesson%>,<%=material%>,<%=Session("userID")%>)">
          </td>          
        </tr>        
      </table>
    </tr>
