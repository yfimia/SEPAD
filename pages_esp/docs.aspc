...
%>
      <table width="100%" cellpadding="1" cellspacing="1" border="0">
        <tr> 
          <td  nowrap width="100%" colspan=4 class="ToolBar" align="center"><b>Materiales de la lección</b></td>
        </tr>
        ...
        <tr width="100%"> 
          ...
          <td width="50%" class="ToolBar" align="center"><b>Descripci&oacute;n</b></td>
        </tr>
...
%>     
        ...
        <tr width="100%" class="<%=trclass %>" valign="middle"> 
          ...
          <td width="48%" align="justify"><%=desc %></td>
        </tr>
