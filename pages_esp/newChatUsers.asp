  ...
  <table width="100%" border=0 cellpadding=0 cellspacing=0>
    ...
    <tr>
      ...
      <td  align=left>
        ...
        %>
        [<b><a href="javascript:abreVentana( 'PMD<%=Session("userID")%>para<%=oRec.Fields.Item("Usuario").value%>', 800, 100, 'newChatPrivateMessanger.asp?salaid=<%=sala%>&userid=<%=oRec.Fields.Item("Usuario").value%>');"><%=oRec.Fields.Item("name").value%></a></b>] 
        <%
        }
        %>
      </td>
