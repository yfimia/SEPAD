...
<!-- #include file='inc\findTutor.inc' -->
...
<%    
      ...
      oComm.CommandText = "SELECT Usuarios.*, Usuarios.ID, Usuarios.Name " +
                          "FROM Usuarios INNER JOIN Grupos_de_Usuarios ON Usuarios.ID = Grupos_de_Usuarios.[User] " +
                          "WHERE (((Grupos_de_Usuarios.[Group])=" + Session("admclaustro") + "))ORDER BY Usuarios.Name";
                          
      oRec = oComm.Execute();    
%>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td class="ToolBar" align="center"><b><%=ListadoU%></b></td>
  </tr>
  <tr> 
    <td> 
      <table width="100%" border="0" cellspacing="1" cellpadding="0">
        <tr> 
          ...
          <td width="20%" class="ToolBar" align="center"><b><%=Ident%></b></td>
          <td width="40%" class="ToolBar" align="center"><b><%=NombreCompleto%></b></td>
          <td width="35%" class="ToolBar" align="center"><b><%=Correo%></b></td>
        </tr>
...
//          Response.Write('<tr><td><INPUT id=Buton name=Buton type=Submit value=Borrar></td><td><INPUT id=Buton name=Buton type=Submit value=Regresar onclick="history.back(-1)"></td></tr>');
        ...
        {
%>        
          <tr><td align="center" width="100%" colspan="4" class="MessageTR"><%=NoElementos%></td></tr>        
<%          
        }  
%>        
...
<!--          <td>|</td>
          <td><a target="_self" href="findUser.asp?uid=<%=uid%>&first=<%=last%>" class="ToolLink">&nbsp;<%=Proximos%>&nbsp;<%=SHOW_CANT%>&nbsp;</a></td>
-->          
        </tr>
      </table>
    </td>
