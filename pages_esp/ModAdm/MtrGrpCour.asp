...
<form name=Delnews action="ConfirmAgregaGroupCur.asp?uid=<%=uid%>&first=<%=last%>" method="post">
    ...
    <td>
      <table border="0" cellspacing="0" cellpadding="4" class="ToolBar">
        <tr> 
          ...
          <td>|</td>
          <td><a href="mtrgrpcour.asp?uid=<%=uid%>&first=<%=last%>" class="ToolLink">&nbsp;Próximos&nbsp;<%=SHOW_CANT%>&nbsp;</a></td>
        </tr>
      </table>
    </td>
  </tr>
