     ...
     // Color3:Color de la pregunta
      {
        ...
        document.write('           <td width="1%">'); 
           if (Resp[i] == 'true' )
             document.write('             <input disabled checked type="checkbox" name="' + 'O' + ID + '#' + i + '" value="checkbox">');
           else  
             document.write('             <input disabled type="checkbox" name="' + 'O' + ID + '#' + i + '" value="checkbox">');
     ...
     // Color4:Color del texto de las celdas
      { 
		...
		if (i < Option2.length)
          {
		document.write('                      <td width="1%"> ');
		document.write('                        <select disabled name="O' + ID + '#' + i + '">');
           if (Resp[i] == ("-1"))
        ...
        while (p < Positions.length)
          {
            ...
            document.write("<input disabled SIZE='" + Lengths[p] + "' TYPE='TEXT' NAME='O" + ID + "#" + p + "' class='Edit' value=" + Resp[p] + ">");
    ...
    function EType6(ID, Texto,Pwidth,Pheight,Color1,Color2,Color3)
     ...
     //Color1: Color de la respuesta
      {   
		...
		document.write('        <tr> ');
		document.write('          <td>');
		document.write('            <textarea disabled class="TextArea" id="O' + ID + '#0" name="O' + ID + '#0" class="Edit" rows="13">' + Resp[0] + '</textarea>');
		document.write('          </td>');
		document.write('        </tr>');
		document.write('      </table>');
		document.write('      <hr noshade>');
