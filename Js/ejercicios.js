    ...
    function EType2(Option1, Option2, Texto, ID, Color1, Color2, Color3, Color4)
     ...
     // Color4:Color del texto de las celdas
      { 
		...
		if (i < Option2.length)
          {
		document.write('                      <td valign="top" width="1%"> ');
        ...
        while (p < Positions.length)
          {
            ...
            document.write("<input SIZE='" + Lengths[p] + "' TYPE='TEXT' NAME='O" + ID + "#" + p + "' class='Edit'>");
    ...
    function EType6(ID, Texto,Pwidth,Pheight,Color1,Color2,Color3)
     ...
     //Color1: Color de la respuesta
      {   
		...
		document.write('        <tr> ');
		document.write('          <td>');
		document.write('            <textarea class="TextArea" id="O' + ID + '#0" name="O' + ID + '#0" class="Edit" rows="13"></textarea>');
		document.write('          </td>');
		document.write('        </tr>');
		document.write('      </table>');
		document.write('      <hr noshade>');
